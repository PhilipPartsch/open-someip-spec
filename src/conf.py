...
needs_global_options = {
   ...
   "heading": {
      "predicates": [
         (
            "type == 'heading'",
            "[[copy('id', filter='\"heading\" == type and current_need[\"id\"] != id and current_need[\"sections\"] == sections and current_need[\"docname\"][-1] == docname and current_need[\"doctype\"] == doctype')]]"
        ),
      ],
